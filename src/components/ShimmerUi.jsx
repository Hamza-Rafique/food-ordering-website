import wavinghand from "../../public/images/wavinghand.png";
const ShimmerUi = () => {
  return (
    <div className="pt-[88px]">
      <div className="flex flex-col justify-center carousel-loading h-80 gap-7">
        ...
        <div className="flex justify-center align-middle gap-3">
          <h1 className="text-4xl font-ProximaNovaThin">Hey Danyal </h1>
          <img src={wavinghand} alt="waving hand" />
        </div>
        <h2 className="text-2xl font-ProximaNovaThin">It’s dinner time!</h2>
